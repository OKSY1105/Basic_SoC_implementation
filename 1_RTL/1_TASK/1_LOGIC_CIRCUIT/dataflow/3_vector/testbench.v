...
// Module instantiation 수정: 포트 매핑 ( .모듈포트(테스트벤치신호) )
vector_scalar u_vector_scalar (
    .i_vector_0    ( vector_0_in    ),
    .o_scala_0     ( scala_0_out_0  ),
    .o_scala_1     ( scala_0_out_1  ),
    .o_scala_2     ( scala_0_out_2  ),
    .o_scala_3     ( scala_0_out_3  ),
    .i_scala_1     ( scala_1_in     ),
    .o_vector_1    ( vector_1_out   ),
    .i_vector_2    ( vector_2_in    ),
    .o_vector_2    ( vector_2_out   ),
    .i_vector_3_0  ( vector_3_in_0  ),
    .i_vector_3_1  ( vector_3_in_1  ),
    .i_vector_3_2  ( vector_3_in_2  ),
    .o_vector_3    ( vector_3_out   )
);
