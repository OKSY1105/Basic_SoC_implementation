...
# Generated on: Thu Jul 09 06:44:20 KST 2026 (Wed Jul 08 21:44:20 UTC 2026)
...
set logfile fv/digtimer/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/digtimer -revised fv_map
...
add_search_path /home/hah010/Basic_SoC_implementation/1_RTL/2_TINY_PROJECT/Timer -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah010/Basic_SoC_implementation/1_RTL/2_TINY_PROJECT/Timer/digtimer.v
elaborate_design -golden -root {digtimer} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/digtimer/fv_map.v.gz
elaborate_design -revised -root {digtimer}
...
#add_name_alias fv/digtimer/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.digtimer.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.digtimer.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.digtimer.rtl.fv_map.rpt
