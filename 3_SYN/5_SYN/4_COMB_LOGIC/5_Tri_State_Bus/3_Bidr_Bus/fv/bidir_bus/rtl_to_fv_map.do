...
# Generated on: Wed Jul 08 03:22:55 KST 2026 (Tue Jul 07 18:22:55 UTC 2026)
...
set logfile fv/bidir_bus/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/bidir_bus -revised fv_map
...
add_search_path /home/hah010/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/5_Tri_State_Bus/3_Bidr_Bus -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah010/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/5_Tri_State_Bus/3_Bidr_Bus/bidir_bus.v
elaborate_design -golden -root {bidir_bus} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/bidir_bus/fv_map.v.gz
elaborate_design -revised -root {bidir_bus}
...
set_system_mode lec
write_compared_points noneq.compared_points.bidir_bus.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.bidir_bus.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.bidir_bus.rtl.fv_map.rpt
