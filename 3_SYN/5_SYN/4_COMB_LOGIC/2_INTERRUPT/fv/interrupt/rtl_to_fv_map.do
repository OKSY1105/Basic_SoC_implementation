...
# Generated on: Wed Jul 08 02:37:32 KST 2026 (Tue Jul 07 17:37:32 UTC 2026)
...
set logfile fv/interrupt/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/interrupt -revised fv_map
...
add_search_path /home/hah010/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/2_INTERRUPT -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah010/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/2_INTERRUPT/interrupt.v
elaborate_design -golden -root {interrupt} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/interrupt/fv_map.v.gz
elaborate_design -revised -root {interrupt}
...
set_system_mode lec
write_compared_points noneq.compared_points.interrupt.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.interrupt.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.interrupt.rtl.fv_map.rpt
