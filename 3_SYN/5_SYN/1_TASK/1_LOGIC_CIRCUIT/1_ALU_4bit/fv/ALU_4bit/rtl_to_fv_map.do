...
# Generated on: Tue Jul 14 20:21:38 KST 2026 (Tue Jul 14 11:21:38 UTC 2026)
...
set logfile fv/ALU_4bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ALU_4bit -revised fv_map
...
add_search_path /home/hah010/Basic_SoC_implementation/1_RTL/1_TASK/1_LOGIC_CIRCUIT/behavior/1_4bit_ALU -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah010/Basic_SoC_implementation/1_RTL/1_TASK/1_LOGIC_CIRCUIT/behavior/1_4bit_ALU/ALU_4bit.v
elaborate_design -golden -root {ALU_4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ALU_4bit/fv_map.v.gz
elaborate_design -revised -root {ALU_4bit}
...
#add_name_alias fv/ALU_4bit/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.ALU_4bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ALU_4bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ALU_4bit.rtl.fv_map.rpt
